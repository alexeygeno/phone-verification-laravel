...
return [
    ...
    'initiation_rate_limit' => 'You can send only :sms sms in :hours hours',
    'completion_rate_limit' => 'You are trying to use an incorrect code :times times in :minutes minutes',
